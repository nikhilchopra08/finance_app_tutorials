...
interface DataCardProps extends boxVarient , iconVarient{
    icon : IconType;
    title : string;
    value? : number;
    dateRange : string;
    ...
    return (
        <Card className="border-none drop-shadow-sm">
            ...
            <CardContent>
                ...
                >{formatPercentage(percentageChange , {addPrefix : true})} from last period</p>
            </CardContent>
        </Card>
    )
}
...
export const DataCardLoading = () => {
    return (
        <div className="border-none drop-shadow-sm h-[192px]">
            <CardHeader className="flex flex-row items-center justify-between gap-x-4">
                <div className="space-y-2">
